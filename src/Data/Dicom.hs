-- $Id: Dicom.hs 158 2010-11-09 01:28:44Z james $
-----------------------------------------------------------------------------
-- |
-- Module      : Dicom
-- Copyright   : James d'Arcy
...
getSyntaxElementFn tags =
  case Map.lookup tRANSFER_SYNTAX_UID tags of
    ...
    Just de ->
      ...
      case syntax of
        "1.2.840.10008.1.2.4.91" -> getDicomJpeg2000Element
        "1.2.840.10008.1.2.1" -> getDicomExpLeElement
        "1.2.840.10008.1.2" -> getDicomImpLeElement
